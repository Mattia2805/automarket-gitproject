...
def inquiry(request):
    if request.method == 'POST':
        ...
        send_mail(
            "New Car Inquiry",
            "You have a new inquiry." + car_title + '. Login to your admin panel for more information.',
        ...
        contact.save()
        messages.success(request, 'Your request has been submitted, we will get back to you shorty.')
        return redirect('/cars/'+car_id)
