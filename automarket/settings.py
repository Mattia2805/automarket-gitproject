...
SECRET_KEY = 'django-insecure-f=$qk*5-=8o7sr)@$-y28v1a!l$4thls^@yn6he7rl59mrh0um'
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    },
    {
        ...
        'OPTIONS': {'min_length': 8},  # optional: set minimum length
    },
    {
...
# Where Django looks for your development static files
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'automarket/static'),
]
